...
namespace Cakes.Controllers
{
    public class CakesController : Controller
    {
        ...
        public CakesController(CakesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Recipe")] Cake cake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Recipe")] Cake cake)
        {
            if (id != cake.Id)
            {
                return NotFound();
